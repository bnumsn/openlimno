...
(
    set +e
    {
        ...
        # eval): strip OPENAI_API_KEY for the same reason claude has
        # ANTHROPIC_* stripped — keep the CLI-subscription-only promise
        # against stale shell exports.
...
(
    set +e
    {
        ...
        echo
        # v0.1.0-final residual #1: strip GEMINI_API_KEY,
        # GOOGLE_API_KEY, and GOOGLE_GENERATIVE_AI_API_KEY for the
        # same reason — gemini-cli honors all three.
